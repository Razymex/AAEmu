...
/// <summary>
/// Progress: synthesis infusions consumed after accept.
/// </summary>
public class QuestActObjConsumeEvolvingMaterial(QuestComponentTemplate parentComponent) : QuestActTemplate(parentComponent)
{
    ...
    {
        Logger.Debug(
            "{0}({1}).RunAct: Quest {2}, Owner {3}, Infusions {4}/{5}",
    ...
    {
        if (questAct.Template.ActId != ActId || e.Kind != QuestProgressStatKind.EvolvingMaterial || e.Amount <= 0)
            return;
