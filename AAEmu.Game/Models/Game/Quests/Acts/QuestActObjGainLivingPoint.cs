...
/// <summary>
/// Progress: vocation / living points gained after accept.
/// </summary>
public class QuestActObjGainLivingPoint(QuestComponentTemplate parentComponent) : QuestActTemplate(parentComponent)
{
    ...
    {
        Logger.Debug(
            "{0}({1}).RunAct: Quest {2}, Owner {3}, Living {4}/{5}",
    ...
    {
        if (questAct.Template.ActId != ActId || e.Kind != QuestProgressStatKind.Living || e.Amount <= 0)
            return;
