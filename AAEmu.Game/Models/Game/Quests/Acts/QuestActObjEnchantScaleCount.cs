...
/// <summary>
/// Progress: settled temper attempts after accept (success, fail, or break).
/// </summary>
public class QuestActObjEnchantScaleCount(QuestComponentTemplate parentComponent) : QuestActTemplate(parentComponent)
{
    ...
    {
        Logger.Debug(
            "{0}({1}).RunAct: Quest {2}, Owner {3}, Temper {4}/{5}",
    ...
    {
        if (questAct.Template.ActId != ActId || e.Kind != QuestProgressStatKind.EnchantScale || e.Amount <= 0)
            return;
